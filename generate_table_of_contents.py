...
def generate_table_of_contents(output_folder):
    ...
    # Define the prompt
    prompt = f"Please generate a research table of contents based on the provided research objectives and the user's research goal. The research objectives are as follows:\n\n{objectives_text}\n\nThe user's research goal is: '{user_goal}'. Create namings for the parts that need namings. Namings should not be too technical. There should be no more than two chapters. Chapters should consist of no more than three sections. The table of contents should be structured as follows:\n\n1. Title page\n2. Abstract\n3. Introduction\n4. Literature review\n5. Chapter 1. (Theoretical, don't mention the word 'theoretical', up to 5 words)\n5.1. Section 1.1: Name of the section (up to 5 words)\n5.2. Section 1.2: Name of the section (up to 5 words)\n5.3. Section 1.3: Name of the section (up to 5 words)\n6. Chapter 2 (Practical, don't mention the word 'practical', up to 5 words)\n6.1. Section 2.1: Name of the section (up to 5 words)\n6.2. Section 2.2: Name of the section (up to 5 words)\n6.3. Section 2.3: Name of the section (up to 5 words)\n7. Conclusion\n8. List of literature sources."
