...
def generate_conclusion(output_folder):
    ...
    # Define the prompt
    prompt = f"""GPT, please generate the Conclusion section for our research paper based on the provided information. The conclusion should reflect upon the fulfillment of the research goals and objectives, justify the relevance of the chosen topic, describe the activities carried out, and analyze the obstacles faced during the research. The conclusion should start with a few introductory sentences, provide a brief summary of the main part of the paper, and offer conclusions and recommendations. It should end with a memorable final paragraph. Please ensure that the Conclusion section is concise, coherent, and engaging.
